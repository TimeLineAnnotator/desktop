...
class TestTimelines:
    ...
    def test_serialize_timelines_serializes_ordinals(self, tls):
        ...
        assert serialized[0][tl1.id]["ordinal"] == 1
        assert serialized[0][tl1.id]["kind"] == "SLIDER_TIMELINE"
        assert serialized[0][tl2.id]["ordinal"] == 2
        assert serialized[0][tl2.id]["kind"] == "HIERARCHY_TIMELINE"
        assert serialized[0][tl3.id]["ordinal"] == 3
        assert serialized[0][tl3.id]["kind"] == "MARKER_TIMELINE"
        assert serialized[0][tl4.id]["ordinal"] == 4
        assert serialized[0][tl4.id]["kind"] == "BEAT_TIMELINE"
