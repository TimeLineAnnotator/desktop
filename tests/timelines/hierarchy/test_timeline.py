...
from tilia.timelines.hierarchy.timeline import HierarchyTLComponentManager, HierarchyTimeline, ParentChildRelation
...
from tilia.ui.tkinter.timelines.common import TimelineUIElementManager, TkTimelineUICollection
...
class TestHierarchyTimeline:
    ...
    def test_create_hierarchy(self):
        ...
        tl.ui.get_ui_for_component.assert_called_with(ComponentKind.HIERARCHY, ANY, start=0, end=1, level=1)
    ...
    def test_serialize_unit_with_parent(self, tl):
        ...
        unit2 = tl.create_timeline_component(
            ComponentKind.HIERARCHY,
            0, 1, 2
        )

        tl.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit2, children=[unit1]))
        # noinspection PyTypeChecker
        srlz_unit1 = serialize_component(unit1)
    ...
    def test_serialize_unit_with_children(self, tl):
        ...
        unit3 = tl.create_timeline_component(
            ComponentKind.HIERARCHY,
            0, 1, 2
        )

        tl.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit3, children=[unit1, unit2]))
        # noinspection PyTypeChecker
    ...
    @patch('tilia.timelines.hierarchy.timeline.HierarchyTimeline.update_ui_with_parent_child_relation')
    def test_deserialize_unit_with_parent(self, update_ui_parent_child_mock, tl_with_ui):
        ...
        tl_with_ui.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit2, children=[unit1]))
    ...
    # noinspection PyTypeChecker, PyUnresolvedReferences
    @patch('tilia.timelines.hierarchy.timeline.HierarchyTimeline.update_ui_with_parent_child_relation')
    def test_deserialize_unit_with_children(self, update_ui_parent_child_mock, tl_with_ui):
        ...
        tl_with_ui.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit3, children=[unit1, unit2]))
    ...
    def test_serialize_timeline(self, tl_with_ui):
        _ = tl_with_ui.create_timeline_component(
            ComponentKind.HIERARCHY,
            0, 0.5, 1
        )
...
class TestHierarchyTimelineComponentManager:
    ...
    def test_create_component(self):
        component_manager = HierarchyTLComponentManager()
        hunit = component_manager.create_component(ComponentKind.HIERARCHY, timeline=MagicMock(), start=0, end=0, level=1)
        assert hunit
    ...
    def test_create_unit_below(self):
        ...
        parent = component_manager.create_component(ComponentKind.HIERARCHY, timeline=MagicMock(), start=0, end=0, level=3)
        child = component_manager.create_component(ComponentKind.HIERARCHY, timeline=MagicMock(), start=0, end=0, level=1)

        component_manager._make_parent_child_relation(ParentChildRelation(parent=parent, children=[child]))
    ...
    def test_clear(self, tl):
        _ = tl.create_timeline_component(ComponentKind.HIERARCHY, start=0.0, end=0.1,
                                                     level=1)
        _ = tl.create_timeline_component(ComponentKind.HIERARCHY, start=0.1, end=0.2,
                                                     level=2)
        _ = tl.create_timeline_component(ComponentKind.HIERARCHY, start=0.2, end=0.3,
                                                     level=3)
    ...
    def test_group_two_units(self, tl):
        ...
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0, end=0.1, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=1)
    ...
    def test_group_two_units_with_units_of_same_level_in_between(self, tl):
        ...
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0, end=0.1, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=1)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.2, end=0.3, level=1)
        unit4 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.3, end=0.4, level=1)
    ...
    def test_group_two_units_with_units_of_different_level_in_between(self, tl):
        ...
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0, end=0.1, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=2)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.2, end=0.3, level=3)
        unit4 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.3, end=0.4, level=1)
    ...
    def test_group_two_units_with_unit_with_children_in_between(self, tl):
        ...
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0, end=0.1, level=2)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=1)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.2, end=0.3, level=1)
        unit4 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.3, level=2)
        tl.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit4, children=[unit2, unit3]))
        unit5 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.3, end=0.4, level=2)
    ...
    def test_group_three_units_with_units_between_grouped_units(self, tl):
        ...
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.2, end=0.3, level=1)
        unit4 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.3, end=0.4, level=1)
        unit5 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.4, end=0.5, level=1)
    ...
    def test_group_crossing_end_boundary_raises_error(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.1, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=1)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.2, level=2)
        unit4 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.2, end=0.3, level=1)
    ...
    def test_group_overlapping_with_higher_unit_raises_error(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.1,
                                                      level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2,
                                                      level=1)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.2,
                                                      level=2)
    ...
    def test_get_unit_for_split_from_single_unit(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=1, level=1)
    ...
    def test_get_unit_for_split_from_unit_boundary(self, tl):
        _ = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.5,
                                                      level=1)
        _ = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.5, end=1,
                                                      level=1)
    ...
    def test_get_unit_for_split_from_units_of_different_levels_spanning_time(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=1, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=1, level=2)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=1, level=3)
    ...
    def test_split_unit_with_children(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.5, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.5, end=1, level=1)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0, end=1, level=2)
    ...
    def test_merge_two_units_without_units_between(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.5,
                                                      level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.5, end=1,
                                                      level=1)
    ...
    def test_merge_two_units_with_children(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.5, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.5, level=2)
        tl.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit2, children=[unit1]))
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.5, end=1.0, level=1)
        unit4 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.5, end=1.0, level=2)
        tl.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit4, children=[unit3]))
    ...
    def test_merge_two_units_with_common_parent(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.5, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.5, end=1, level=1)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.1, level=2)
    ...
    def test_merge_two_units_with_unit_with_children_in_between(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.1, level=2)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=2)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=1)
        tl.component_manager._make_parent_child_relation(ParentChildRelation(parent=unit2, children=[unit3]))
        unit4 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.2, end=0.3, level=2)
    ...
    def test_merge_with_different_parent_raises_error(self, tl):
        unit1 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.0, end=0.1, level=1)
        unit2 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=1)
        unit3 = tl.component_manager.create_component(ComponentKind.HIERARCHY, timeline=tl, start=0.1, end=0.2, level=2)
    ...
    def test_serialize_components(self, tl_with_ui):
        unit1 = tl_with_ui.create_timeline_component(ComponentKind.HIERARCHY, start=0.0, end=0.1,
                                                      level=1)
        unit2 = tl_with_ui.create_timeline_component(ComponentKind.HIERARCHY, start=0.1, end=0.2,
                                                      level=2)
        unit3 = tl_with_ui.create_timeline_component(ComponentKind.HIERARCHY, start=0.2, end=0.3,
                                                      level=3)
    ...
    def test_deserialize_components(self, tl_with_ui):
        ...
        tl_with_ui.component_manager.deserialize_components(
            serialized_components
        )

        assert len(tl_with_ui.component_manager._components) == 3
        assert {dsu.start for dsu in tl_with_ui.component_manager._components} == {u.start for u in [unit1, unit2, unit3]}
        assert {dsu.end for dsu in tl_with_ui.component_manager._components} == {u.end for u in [unit1, unit2, unit3]}
        assert {dsu.level for dsu in tl_with_ui.component_manager._components} == {u.level for u in [unit1, unit2, unit3]}
