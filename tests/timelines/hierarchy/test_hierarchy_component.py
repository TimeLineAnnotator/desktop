...
class TestHierarchyComponent:
    ...
    def test_set_end_changes_post_end_not_previously_equal_1(self):
        hrc = Hierarchy(DummyHierarchyTL(), 0, 1, 2, 1, post_end=2.5)
