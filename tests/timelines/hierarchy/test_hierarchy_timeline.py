...
class TestHierarchyTimeline:
    ...
    # TEST SERIALIZE
    def test_serialize_unit(self, hierarchy_tl):
        unit_kwargs = {
            "start": 0,
            "end": 1,
            "level": 1,
        ...
        hrc1, _ = hierarchy_tl.create_hierarchy(**unit_kwargs)
    ...
    def test_serialize_unit_with_parent(self, hierarchy_tl):
        hrc1, _ = hierarchy_tl.create_hierarchy(0, 1, 1)

        hrc2, _ = hierarchy_tl.create_hierarchy(0, 1, 2)
    ...
    def test_serialize_unit_with_children(self, hierarchy_tl):
        hrc1, _ = hierarchy_tl.create_hierarchy(0, 0.5, 1)

        hrc2, _ = hierarchy_tl.create_hierarchy(0.5, 1, 1)

        hrc3, _ = hierarchy_tl.create_hierarchy(0, 1, 2)
    ...
    def test_deserialize_unit(self, hierarchy_tl):
        unit_kwargs = {
            "start": 0,
            "end": 1,
            "level": 1,
        ...
        deserialized_hrc1 = _deserialize_component(hierarchy_tl, serialized_hrc1)
    ...
    def test_deserialize_unit_with_parent(self, hierarchy_tl):
        hrc1, _ = hierarchy_tl.create_hierarchy(0, 1, 1)
    ...
    # noinspection PyTypeChecker, PyUnresolvedReferences
    def test_deserialize_unit_with_children(self, hierarchy_tl):
        hrc1, _ = hierarchy_tl.create_hierarchy(0, 0.5, 1)
        hrc2, _ = hierarchy_tl.create_hierarchy(0.5, 1, 1)
        hrc3, _ = hierarchy_tl.create_hierarchy(0, 1, 2)
        ...
        deserialized_hrc3 = _deserialize_component(hierarchy_tl, serialized_hrc3)
    ...
    def test_serialize_timeline(self, hierarchy_tl):
        hierarchy_tl.create_hierarchy(0, 0.5, 1)

        serialized_timeline = hierarchy_tl.get_state()
