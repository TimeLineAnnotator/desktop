...
class AddTimelineWithoutMedia(QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(tilia.ui.strings.ASK_ADD_TIMELINE_WITHOUT_MEDIA_DIALOG_TITLE)
        ...
        self._prompt = QLabel(tilia.ui.strings.ASK_ADD_TIMELINE_WITHOUT_MEDIA_DIALOG_PROMPT)
        _load_media_button.setText(tilia.ui.strings.ASK_ADD_TIMELINE_WITHOUT_MEDIA_DIALOG_LOAD_MEDIA)
        _set_media_duration_button.setText(tilia.ui.strings.ASK_ADD_TIMELINE_WITHOUT_MEDIA_DIALOG_SET_MEDIA_DURATION)
        ...
        _button_box = QDialogButtonBox(QDialogButtonBox.StandardButton.Ok | QDialogButtonBox.StandardButton.Cancel, self)
